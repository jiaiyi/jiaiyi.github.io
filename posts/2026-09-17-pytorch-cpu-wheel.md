---
title: 装完 PyTorch 发现 GPU 用不上？先看看你装的是不是 CPU 版
date: 2026-09-17
tags: [PyTorch, Windows, 环境配置]
summary: pip install torch 一路顺利，torch.cuda.is_available() 却是 False。根因很可能是：PyPI（含国内镜像）上的 Windows torch wheel 根本就是 CPU 版。
---
